<%@ Page Title="" Language="C#" MasterPageFile="~/DL.Master" AutoEventWireup="true" CodeBehind="DLAddTask.aspx.cs" Inherits="TaurusCapstone.WebForm19" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
  ...
  <fieldset>
    <h3 style="font-family: Avenir LT Std 65 Medium; text-align: center">A New Task</h3>
      ...
      <div class="">
           <label for="select" class="col-lg-2 control-label">Task Name</label>
      </div>
      <div class="col-xs-4">
          <input type="text" class="form-control" id="taskName" runat="server">
      </div>
      <br />
      <div class="form-group">
      <label for="inputPassword" class="auto-style6">Task Leads</label>
      <div class="col-xs-4">
          <asp:CheckBoxList ID="taskLeads " runat="server"></asp:CheckBoxList>
          <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="TaurusCapstone.PMSDataClassesDataContext" EntityTypeName="" Select="new (FirstName, EmployeeID)" TableName="Employees">
          </asp:LinqDataSource>
      </div>
        </div>
      <div class="form-group">
      <label for="nameLabel" class="auto-style5">Description</label>
        <div class="col-xs-4">
        <textarea class="form-control" rows="5" id="tDescription" runat="server"></textarea>
        </div>
        </div>
    ...
    <div class="form-group">
      ...
      <br />
      <div class="form-group">
      <label for="nameLabel" class="auto-style5">Cost</label>
      <div class="col-xs-4">
        <input type="text" class="form-control" id="taskCost" runat="server">
    ...
    <div class="form-group">
      <div class="col-xs-4 col-lg-offset-2">
        <button type="submit" class="btn btn-default" style="color: white; background-color: black" runat="server" id="submit" onserverclick="submit_ServerClick" >Submit</button>
